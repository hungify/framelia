...
export async function run(
  ...
  // Runtime-scoped, not global: an injected CliRuntime carries its own cwd and env,
  // and every command reads env through that runtime (see internal/figma-token.ts).
