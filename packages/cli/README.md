...
[`.framelia/README.md`](../../.framelia/README.md) — this README documents the CLI surface around
...
Writes `framelia.config.ts` with an optional, commented `storageStatePath` example. Project
...
[`.framelia/README.md`](../../.framelia/README.md)) to produce `visual-verification.json` artifacts
