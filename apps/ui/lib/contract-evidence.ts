...
function groupBySelector(issues: UITopIssue[]): TopIssueGroup[] {
  const groups = new Map<string | null, UITopIssue[]>();
 ...
 */
export function groupStyleMismatches(topIssues: UITopIssue[] | undefined): TopIssueGroup[] {
 ...
 */
export function groupPixelAttributions(topIssues: UITopIssue[] | undefined): TopIssueGroup[] {
