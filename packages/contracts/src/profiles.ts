import type { ProfileName, ProfileOverrides } from "./visual-contract.ts";
...
/** Resolves the thresholds used for comparison, preserving defaults for undefined overrides. */
export function resolveDisplayThreshold(source: ThresholdOverrideSource): Profile {
  return {
    ...getProfile(source.profile ?? "page"),
    ...Object.fromEntries(
      Object.entries(source.profileOverrides ?? {}).filter(([, value]) => value !== undefined),
    ),
