...
<template>
  ...
  >
    ...
    >
      <span
        aria-hidden="true"
        class="absolute top-1/2 left-1/2 w-4.5 h-7.5 border border-accent rounded-[3px] bg-[#20252b] -translate-x-1/2 -translate-y-1/2 before:content-[''] before:absolute before:top-1/2 before:left-0.75 before:w-0 before:h-0 before:border-t-[3px] before:border-b-[3px] before:border-t-transparent before:border-b-transparent before:border-r-[3px] before:border-r-accent before:-translate-y-1/2 after:content-[''] after:absolute after:top-1/2 after:right-0.75 after:w-0 after:h-0 after:border-t-[3px] after:border-b-[3px] after:border-t-transparent after:border-b-transparent after:border-l-[3px] after:border-l-accent after:-translate-y-1/2"
      />
    </div>
  </div>
</template>
