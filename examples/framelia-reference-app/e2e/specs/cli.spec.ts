...
// `framelia`'s library surface only covers config/dashboard APIs now (see
// packages/cli/src/index.ts) -- schemas and verification types come from
// @framelia/contracts directly, per the interface-boundary migration.
