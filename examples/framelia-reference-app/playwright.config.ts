...
export default defineConfig({
  ...
  // toMatchFigma does real Figma REST fetches (metadata + image render) bounded by
  // this.timeout inside the matcher; the 5s Playwright default is too tight for that.
  expect: {
    timeout: 30_000,
  },
  use: {
