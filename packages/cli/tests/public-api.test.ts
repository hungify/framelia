...
/**
 * Phase 0 baseline (see the CLI v2 rewrite plan): freezes the public package
 * interface before any internal reorganization. If this test starts failing
 * during the rewrite, an export moved or disappeared -- that's a compatibility
